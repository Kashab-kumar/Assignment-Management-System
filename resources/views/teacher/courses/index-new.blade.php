...
<div class="courses-container">
    <div class="courses-header">
        <h1>All Courses</h1>
        <p>Manage and monitor your courses</p>
    </div>
            ...
            <div class="filter-group">
                ...
                <div class="filter-actions">
                    @if($selectedCategory || $selectedClass)
                        <a href="{{ route('teacher.courses.index') }}" class="btn-filter btn-clear">Clear Filters</a>
                    @endif
                </div>
            </div>
        </form>
                ...
                <div class="course-card">
                    ...
                    <div class="course-footer">
                        <div class="course-actions">
                            <a href="{{ route('teacher.courses.show', $course) }}" class="btn btn-primary">Manage</a>
                            <a href="{{ route('teacher.courses.show', $course) }}" class="btn btn-secondary">View Details</a>
                        </div>
                    </div>
                </div>
            @endforeach
